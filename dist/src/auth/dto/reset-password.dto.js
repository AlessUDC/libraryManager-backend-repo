...
__decorate([
    ...
    (0, class_validator_1.Length)(6, 6, { message: 'El token debe tener 6 dígitos' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'La confirmación de contraseña es obligatoria' }),
    __metadata("design:type", String)
